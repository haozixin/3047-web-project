...
INSERT INTO `agents` (`id`, `given_name`, `family_name`, `email`, `country`, `city`, `state`, `street`, `user_name`, `password`, `subscription_status`) VALUES
(3, 'pasino', 'AI', '111@222.com', 'IS', 'home', 'home', 'home', NULL, '', 'home'),
