...
class RecipesController extends AppController
{
    ...
    public function view($id = null)
    {
        $recipe = $this->Recipes->get($id, [
            'contain' => ['Videos', 'Photos', 'ProductRecipes'],
        ]);
    ...
    public function add()
    {
        ...
        $videos = $this->Recipes->Videos->find('list', ['limit' => 200]);
        $photos = $this->Recipes->Photos->find('list', ['limit' => 200]);
        $this->set(compact('recipe', 'videos', 'photos'));
    }
