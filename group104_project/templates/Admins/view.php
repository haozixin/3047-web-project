                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'AdminAgents', 'action' => 'view', $adminAgents->agent_id]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'AdminAgents', 'action' => 'edit', $adminAgents->agent_id]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'AdminAgents', 'action' => 'delete', $adminAgents->agent_id], ['confirm' => __('Are you sure you want to delete # {0}?', $adminAgents->agent_id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
