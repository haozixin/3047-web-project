        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $adminAgent->agent_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $adminAgent->agent_id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $adminAgent->agent_id], ['confirm' => __('Are you sure you want to delete # {0}?', $adminAgent->agent_id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
