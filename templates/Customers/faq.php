            ...
            <div class="col-md-4 mb-5">
                <div class="card h-30">
                    <div class="card-body">
                        ...
                        <p class="card-text">MGO is an acronym for a natural compound found in Manuka honey called
                            methylglyoxal, which is responsible for much of the unique medicinal activity of Manuka
                            honey. MGO comes from another component called dihydroxyacetone (DHA), which occurs
                            organically in the nectar of flowers of some Leptospermum plants. Various species of this
                            plant produce different levels of DHA that give rise to the varying antibacterial potencies
                            of this special honey. </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-5">
                <div class="card h-30">
                    <div class="card-body">
                        ...
                        <p class="card-text">Absolutely not. We only use raw, untreated honey of the highest quality,
                            and do not use any quality-detracting heat treatment or artificial additives. This is 100%
                            guaranteed.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-5">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Delivery Charges are usually via Australia post or Aramex courier, with
                            standard price approx $10 AUD for delivery of a single item within Australia, and approx $15
                            for multiple items. We have a wide range of different prices for global delivery, and we try
